...
def trainValImg2Model(total_client,num_clients,epoch,max_acc,
    ...
    test_loader = torch.utils.data.DataLoader(
        CostumDataset(X_val_2_scaled_splits[total_client - 1], Y_val_2_splits[total_client - 1]), batch_size=32)
...
def main():
    ...
    trainValImg2Model(total_client, num_clients, epoch, max_acc,
                      X_train_2_scaled_splits, X_test_2_scaled_splits, X_val_2_scaled_splits,
                      Y_train_2_splits, Y_test_2_splits, Y_val_2_splits)
